...
import './club1_events_page_view.dart';

List<EventItem> eventsList;

class Club1Events extends StatefulWidget {
  @override
  _Club1EventsState createState() => _Club1EventsState();
}

class _Club1EventsState extends State<Club1Events> {
  ...
  @override
    void initState() {
      ...
      eventsList = new List();
      event = new EventItem("", "", "", "","","");
      databaseReference = database.reference().child("Club1");
