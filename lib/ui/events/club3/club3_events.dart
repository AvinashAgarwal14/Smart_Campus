...
import './club3_events_page_view.dart';

List<EventItem> eventsList;

class Club3Events extends StatefulWidget {
  @override
  _Club3EventsState createState() => _Club3EventsState();
}

class _Club3EventsState extends State<Club3Events> {
